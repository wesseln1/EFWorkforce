...
namespace EFWorkForce.Controllers
{
    public class ComputersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Make,Model,PurchaseDate,DecomissionDate")] Computer computer)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Make,Model,PurchaseDate,DecomissionDate")] Computer computer)
        {
            if (id != computer.Id)
            {
                return NotFound();
